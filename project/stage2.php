...
?>
  ...
  <div class="field">
	...
	<form action="register-exec.php" method="post">
		...
		<div class="textright"><input name="location" type="text" class="textfield" id="fname" /></div>
		...
		<div class="textleft">arts :</div>
		<div class="textright"><input name="arts" class="textfield" type="text" />
		</div>
		<div class="textleft">aboutme:</div>
		<div class="textright"><input name="aboutme" class="textfield" type="text" /><input name="userid" type="hidden" id="curcity" value=" <?php echo $_SESSION['SESS_MEMBER_ID'];?>" /></div>
